...
//FILE: table2.h
//DESC: Definition of table class
//
// FILE: table2.h
...
const std::size_t TABLE_SIZE = 1000;
...
// CONSTANT MEMBER FUNCTIONS //
    void find(long key, bool& found, RecordType& result) const;
    bool is_present(long key) const;
    std::size_t size( ) const { return total_records; }

private:

// DATA MEMBERS //
    node<RecordType> *hdata[TABLE_SIZE];// array of TABLE_SIZE pointers to node<RecordType>
    std::size_t total_records;

// HELPER MEMBER FUNCTION //
    std::size_t hash(long key) const;

// FRIENDS //
    friend std::ostream& operator<<<RecordType>(std::ostream &out, const table<RecordType> &obj);
};
